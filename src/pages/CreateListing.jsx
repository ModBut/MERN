                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <button
                         ...
                         border-green-700 rounded uppercase 
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-85 disabled:opacity-80'>{loading ? 'Creating...' : 'Create Listing'}</button>
